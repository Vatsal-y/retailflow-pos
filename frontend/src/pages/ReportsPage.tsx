            ...
            <div className="flex items-center justify-center h-[calc(100vh-8rem)]">
                <div className="text-center">
                    <div className="relative">
                        <div className="w-16 h-16 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 animate-spin" style={{ animationDuration: '2s' }} />
    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-8 text-white">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all ${selectedBranch === null
                        ...
                        {branchPerformance.map((branch) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all ${selectedBranch === branch.branchId
                ...
                <div className="absolute right-20 -top-8 w-32 h-32 rounded-full bg-pink-500/30 blur-3xl" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="group relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl opacity-75 blur group-hover:opacity-100 transition duration-300" />
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-[hsl(var(--muted-foreground))] mt-2">Last 30 days</p>
                                </div>
                ...
                {/* Total Orders */}
                <div className="group relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl opacity-75 blur group-hover:opacity-100 transition duration-300" />
                    <Card className="relative rounded-xl overflow-hidden">
                        <CardContent className="p-6">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-[hsl(var(--muted-foreground))] mt-2">Completed orders</p>
                                </div>
                                <div className="p-3 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 text-white shadow-lg shadow-purple-500/25">
                                    <Package size={24} />
                                </div>
                            </div>
                        </CardContent>
                ...
                {/* Average Order */}
                <div className="group relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl opacity-75 blur group-hover:opacity-100 transition duration-300" />
                    <Card className="relative rounded-xl overflow-hidden">
                        <CardContent className="p-6">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-[hsl(var(--muted-foreground))] mt-2">Per transaction</p>
                                </div>
                ...
                {/* Active Branches */}
                <div className="group relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl opacity-75 blur group-hover:opacity-100 transition duration-300" />
                    <Card className="relative rounded-xl overflow-hidden">
                        <CardContent className="p-6">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-[hsl(var(--muted-foreground))] mt-2">{employeePerformance.length} employees</p>
                                </div>
            ...
            <Card className="overflow-hidden border-0 shadow-xl bg-gradient-to-br from-[hsl(var(--card))] to-[hsl(var(--accent))]">
                        ...
                        <div className="ml-auto flex items-center gap-2">
                            ...
                            {([1, 7, 30] as const).map((period) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all ${trendPeriod === period
                    ...
                    <div className="h-80">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={revenueTrend}>
                                ...
                                />
                                <Legend />
                                <Area type="monotone" dataKey="revenue" name="Revenue" stroke="#6366f1" strokeWidth={3} fill="url(#revenueGradient)" />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </CardContent>
                        ...
                        <div className="h-80">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={topProducts} layout="vertical">
                                    ...
                                    />
                                    <Bar dataKey="quantitySold" fill="url(#barGradient)" name="quantitySold" radius={[0, 8, 8, 0]}>
            ...
            {/* Employee Performance - Enhanced Table */}
            <Card className="overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-b border-[hsl(var(--border))]">
                    <CardTitle className="flex items-center gap-3">
                        ...
                        <table className="w-full">
                            ...
                            <tbody>
                                {employeePerformance.map((emp, index) => (
                                    <tr key={emp.employeeId} className="border-b border-[hsl(var(--border))] hover:bg-[hsl(var(--accent)/0.5)] transition-colors">
                                        <td className="p-4">
                                            {index === 0 ? (
